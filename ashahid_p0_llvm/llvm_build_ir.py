...
#            self.instr[class_name] = temp_var 
    ...
    def Print_Oper(self,operand0):
        Print_Oper(self,operand0)
    ...
    def generate_llvm_ir_py(self):
        return  generate_llvm_ir_py(self)
...
#    assembly_fn = fn.split(".")[0] + ".s"
    ...
    try:
        ...
        py_to_llvm_ir_inst.flatten(ast,0)

#        py_to_llvm_ir_inst.num_vars = len(py_to_x86_inst.prog_ord)

        with open(assembly_fn, 'w') as fh:
            fh.write(py_to_llvm_ir_inst.generate_llvm_ir_py())
